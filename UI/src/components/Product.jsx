    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-wrap justify-center gap-8 max-w-[1600px] mx-auto">
        {products.map((product) => (
          <div
            key={product.id}
            className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 w-full sm:w-[450px] md:w-[450px] lg:w-[450px] flex-shrink-0"
          >
